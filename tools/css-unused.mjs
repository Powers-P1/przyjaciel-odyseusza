// Wykrywa klasy CSS ze src/css/style.css, których nie używa żadna strona w public/ ani skrypt src/js/main.js.
...
if (unused.length) {
  console.error(`Nieużywane klasy w src/css/style.css (${unused.length}):\n  ${unused.join('\n  ')}`);
  process.exit(1);
}
console.log(`src/css/style.css: ${classes.size} klas, wszystkie użyte.`);
